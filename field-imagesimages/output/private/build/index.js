...
_dingtalkDocsCoolApp.fieldDecoratorKit.setDecorator({
  ...
  formItems: [{
    ...
    key: 'imageUrl2',
    label: "".concat(t('param_image_label2')),
    component: _dingtalkDocsCoolApp.FormItemComponent.FieldSelect,
    props: {
      supportTypes: [_dingtalkDocsCoolApp.FieldType.Attachment]
    },
    ...
    key: 'imageUrl3',
    label: "".concat(t('param_image_label3')),
    component: _dingtalkDocsCoolApp.FormItemComponent.FieldSelect,
    props: {
      supportTypes: [_dingtalkDocsCoolApp.FieldType.Attachment]
    },
  ...
  execute: function () {
    var _execute = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(context, formData) {
      var imageUrl1, prompt, model, temperature, topP, topK, candidateCount, imageFields, tmpUrls, _i, _imageFields, imageField, _iterator, _step, image, url, requestBody, init, res, resJson, uploadedImages, _t;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.p = _context.n) {
          case 0:
            imageUrl1 = formData.imageUrl1, prompt = formData.prompt, model = formData.model, temperature = formData.temperature, topP = formData.topP, topK = formData.topK, candidateCount = formData.candidateCount;
            _context.p = 1;
            // 1. 收集所有图片的临时URL
          ...
          case 2:
            ...
            url = 'https://saas.jcbbi.com:8180/api/sysChatChannel/imagebuilderchat';
            requestBody = {
          ...
          case 4:
            resJson = _context.v;
            // 3. 处理响应
            uploadedImages = []; // console.log('===========<resJson', resJson);
